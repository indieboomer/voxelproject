...
pub fn harvest_icon(ui: &mut egui::Ui, item: &str) {
    let (r, _) = ui.allocate_exact_size(egui::vec2(24.0, 24.0), egui::Sense::hover());
    let p = ui.painter();
    p.rect_filled(r, 3., egui::Color32::from_rgb(35, 42, 52));
    let c = r.center();
    match item {
        "harvest:wool" => { p.circle_filled(c, 8., egui::Color32::from_rgb(235,235,225)); p.circle_filled(c+egui::vec2(5.,-2.),5.,egui::Color32::from_rgb(250,250,240)); }
