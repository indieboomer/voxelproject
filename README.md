...
Phase 2A adds [persistent object enchantments](docs/ENCHANTMENTS.md): attach a rule
to a creature, block or device, save it, and inspect its status while aiming.
