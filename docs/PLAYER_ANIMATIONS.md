...
The multiplayer protocol carries the animation clip, playback time, and restart
...
Messages still travel as ordinary text through the shared chat protocol; peers with this build
