...
The axe, pickaxe and sword remain available without a book. Bow and longbow are temporarily disabled; their old save slots are reserved. New recipes consume iron, oak wood, mana and a specialist material. The catalog shows exact costs and missing materials. Salvage returns at most half the specialist recipe's materials and also costs mana. Each player's discoveries and inventory persist separately; the host validates reading and crafting for guests too.
